 ...
 * 
 * NOTA: O sistema de overlay de 15 segundos foi movido para o componente
 * MonetagOverlay.tsx que é carregado globalmente no App.tsx
 * Isso permite que o overlay funcione em QUALQUER tela do aplicativo
 */
