...
try {
    ...
    try {
        ...
        // Tabela de valores de pagamento (padronizado com auto_reset.php)
        $payment_values = [
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            // ============================================
            // Cooldown em HORAS: Top 1-3 = 24h, Top 4-10 = 2h
        ...
        echo json_encode([
            'success' => true,
            'message' => 'Ranking resetado com sucesso! Pagamentos pendentes e cooldowns criados.',
            'data' => [
                'reset_type' => 'ranking',
