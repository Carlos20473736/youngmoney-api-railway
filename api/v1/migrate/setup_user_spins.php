<?php
/**
 * Setup Completo: user_spins
 * 
 * Executa todas as migrações necessárias:
 * 1. Cria tabela user_spins
 * 2. Migra dados de spin_history
 * 3. Adiciona giros iniciais aos usuários
 */
...
try {
    ...
    // Buscar usuários sem giros não usados
    $result = $conn->query("
